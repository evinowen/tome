  ...
  <v-card max-width="640" class="mx-auto">
    <v-card-text>
      <v-list-item>
        ...
        <v-list-item-content>
          <v-list-item-title class="headline">Theme Preview</v-list-item-title>
          <v-list-item-subtitle>Et tortor consequat id porta nibh venenatis cras.</v-list-item-subtitle>
        </v-list-item-content>
      </v-list-item>
      <v-text-field class="mb-2" counter=24 clearable hint="Take a hint." :error=error>User Input</v-text-field>
      ...
      <v-switch dense class="mt-2" label="Error" color="error" v-model=error hide-details></v-switch>
    </v-card-text>
    <v-card-actions>
