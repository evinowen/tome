...
const _component = require('@/../electron/components/git')
const preload = require('@/../electron/components/git/preload')
...
jest.mock('@/../electron/components/git/Repository', () => require('@/../spec/mocks/electron/components/git/Repository'))
